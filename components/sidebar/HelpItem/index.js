...
export default function HelpItem({ isOpen }) {
  return (
    <div className={`flex items-center justify-start h-12 rounded-xl text-[15px] font-semibold text-[#6F767E] gap-2 group px-3 cursor-pointer transition overflow-x-hidden ${!isOpen ? 'hidden md:flex' : ''}`}>
